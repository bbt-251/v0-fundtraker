                        ...
                        <TabsContent value="resources" className="mt-6">
                            <div className="mb-4 border-b border-gray-200 dark:border-gray-700">
                                <div className="flex space-x-4">
                                    <button
                                        ...
                                        className={`pb-2 px-1 ${activeResourceTab === "human"
                                    ...
                                    <button
                                        ...
                                        className={`pb-2 px-1 ${activeResourceTab === "material"
                                            ? "border-b-2 border-blue-500 text-blue-600 dark:text-blue-400"
                                            : "text-gray-500 dark:text-gray-400"
                                            }`}
                                    >
                                    ...
                                    <button
                                        ...
                                        className={`pb-2 px-1 ${activeResourceTab === "financial"
                                            ? "border-b-2 border-blue-500 text-blue-600 dark:text-blue-400"
                                            : "text-gray-500 dark:text-gray-400"
                                            }`}
                                    >
                            ...
                            {activeResourceTab === "financial" && (
                                <div>
                                    ...
                                    {/* hide this section if logged in user is a donor */}
                                    {
                                        !isDonor &&
                                        <>
                            ...
                            <div className="mb-4 border-b border-gray-200 dark:border-gray-700">
                                <div className="flex flex-wrap gap-2">
                                    <button
                                        ...
                                        className={`pb-2 px-1 ${activePlanningTab === "activities"
                                            ? "border-b-2 border-blue-500 text-blue-600 dark:text-blue-400"
                                            : "text-gray-500 dark:text-gray-400"
                                            }`}
                                    >
                                    ...
                                    <button
                                        ...
                                        className={`pb-2 px-1 ${activePlanningTab === "tasks"
                                            ? "border-b-2 border-blue-500 text-blue-600 dark:text-blue-400"
                                            : "text-gray-500 dark:text-gray-400"
                                            }`}
                                    >
                                    ...
                                    <button
                                        ...
                                        className={`pb-2 px-1 ${activePlanningTab === "deliverables"
                                            ? "border-b-2 border-blue-500 text-blue-600 dark:text-blue-400"
                                            : "text-gray-500 dark:text-gray-400"
                                            }`}
                                    >
                                    ...
                                    <button
                                        ...
                                        className={`pb-2 px-1 ${activePlanningTab === "milestones"
                                            ? "border-b-2 border-blue-500 text-blue-600 dark:text-blue-400"
                                            : "text-gray-500 dark:text-gray-400"
                                            }`}
                                    >
                                    ...
                                    <button
                                        ...
                                        className={`pb-2 px-1 ${activePlanningTab === "decisionGates"
                                            ? "border-b-2 border-blue-500 text-blue-600 dark:text-blue-400"
                                            : "text-gray-500 dark:text-gray-400"
                                            }`}
                                    >
                                    ...
                                    <button
                                        ...
                                        className={`pb-2 px-1 ${activePlanningTab === "ganttChart"
                                            ? "border-b-2 border-blue-500 text-blue-600 dark:text-blue-400"
                                            : "text-gray-500 dark:text-gray-400"
                                            }`}
                                    >
                            ...
                            <div className="mb-4 border-b border-gray-200 dark:border-gray-700">
                                <div className="flex space-x-4">
                                    <button
                                        ...
                                        className={`pb-2 px-1 ${activeRiskTab === "list"
                                            ? "border-b-2 border-blue-500 text-blue-600 dark:text-blue-400"
                                            : "text-gray-500 dark:text-gray-400"
                                            }`}
                                    >
                                    ...
                                    <button
                                        ...
                                        className={`pb-2 px-1 ${activeRiskTab === "matrix"
                                            ? "border-b-2 border-blue-500 text-blue-600 dark:text-blue-400"
                                            : "text-gray-500 dark:text-gray-400"
                                            }`}
                                    >
                            ...
                            <div className="mb-4 border-b border-gray-200 dark:border-gray-700">
                                <div className="flex space-x-4">
                                    <button
                                        ...
                                        className={`pb-2 px-1 ${activeCommunicationTab === "plan"
                                            ? "border-b-2 border-blue-500 text-blue-600 dark:text-blue-400"
                                            : "text-gray-500 dark:text-gray-400"
                                            }`}
                                    >
                                    ...
                                    <button
                                        ...
                                        className={`pb-2 px-1 ${activeCommunicationTab === "log"
                                            ? "border-b-2 border-blue-500 text-blue-600 dark:text-blue-400"
                                            : "text-gray-500 dark:text-gray-400"
                                            }`}
                                    >
