                      ...
                      <div className="flex items-center justify-between">
                        <div className="flex items-center">
                          <div className="flex-shrink-0">
                            {idDocStatus.status === "verified" ? (
                              <Check className="h-5 w-5 text-green-500" />
                            ) : idDocStatus.status === "pending" ? (
                          ...
                          <div className="ml-3">
                            ...
                            <p className="text-xs text-gray-500 dark:text-gray-400">
                              Uploaded on {idDocStatus.uploadedAt}
                            </p>
                          </div>
                        </div>
                        <a
                  ...
                  <div className="bg-gray-50 dark:bg-gray-700 p-6 rounded-lg shadow-sm">
                    ...
                    {addressDocStatus ? (
                      <div className="flex items-center justify-between">
                        <div className="flex items-center">
                          <div className="flex-shrink-0">
                            {addressDocStatus.status === "verified" ? (
                              <Check className="h-5 w-5 text-green-500" />
                            ) : addressDocStatus.status === "pending" ? (
                              <Loader2 className="h-5 w-5 text-amber-500 animate-spin" />
                            ) : (
                              <X className="h-5 w-5 text-red-500" />
                            )}
                          ...
                          <div className="ml-3">
                            ...
                            <p className="text-xs text-gray-500 dark:text-gray-400">
                              Uploaded on {addressDocStatus.uploadedAt}
                            </p>
                          </div>
                        </div>
                        <a
