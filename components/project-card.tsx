              ...
              {requirementSections.map((section, sectionIndex) => (
                <div
                  ...
                  className={`border rounded-lg overflow-hidden ${
                    section.allMet ? "border-green-200 dark:border-green-800" : "border-muted dark:border-muted"
                  }`}
                >
                  <div
                    className={`p-4 flex justify-between items-center ${
                      section.allMet ? "bg-green-50 dark:bg-green-900/20" : "bg-muted/30 dark:bg-muted/20"
                    }`}
                  >
                    <div className="flex items-center">
                      {section.allMet ? (
                      ...
                      <h3
                        className={`font-medium ${
                          section.allMet ? "text-green-800 dark:text-green-400" : "text-foreground"
                        }`}
                      >
                        {section.name}
                      </h3>
                    ...
                    <div className="flex items-center">
                      <span
                        className={`text-sm font-medium mr-3 ${
                          section.allMet ? "text-green-700 dark:text-green-500" : "text-muted-foreground"
                        }`}
                      >
                        {section.progress}%
                      </span>
