                                    ...
                                    resourceUtilizationData.map((item, index) => (
                                        <div key={index} className="space-y-2">
                                            ...
                                            <div className="relative h-4 w-full bg-muted rounded-full overflow-hidden">
                                                ...
                                                {/* Actual usage bar */}
                                                <div
                                                    className={`absolute h-full rounded-full ${item.actualPercent > item.allocatedPercent ? "bg-destructive" : "bg-primary"
                                                        }`}
                                            ...
                                            return (
                                                <tr key={budget.id} className="border-b border-muted">
                                                    ...
                                                    <td className="py-4 px-4">
                                                        <span
                                                            className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${budget.status === "Completed"
                                                    ...
                                                    <td className="py-4 px-4">
                                                        {hasRequest ? (
                                                            <span
                                                                className={`px-3 py-1 rounded-full text-xs ${requestStatus === "Approved"
