...
import { createTeamMember } from "@/services/team-member-service"
import { useAuth } from "@/contexts/auth-context"
import type { TeamMemberFormData } from "@/types/team-member"
...
export function AddTeamMemberModal({ open, onOpenChange, onSuccess }: AddTeamMemberModalProps) {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            await createTeamMember(formData, user.uid)
